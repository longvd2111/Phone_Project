                    ...
                    <div class="modal-content">
                        <form action="editURL" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Memory</label>
                                    <input value="${detail.memory}" name="memory" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${listC}" var="o">
                                            <option ${detail.cate_id == o.cate_id ? 'selected' : ''} value="${o.cate_id}">${o.cate_name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
